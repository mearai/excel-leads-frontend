...
const AuthTwoSteps = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            ...
            // You can then use the merged code as needed
            console.log('Merged code:', mergedCode);

            // For demonstration, alert the merged code
            alert('Merged code: ' + mergedCode);
        },
    });
      ...
      <Stack mb={3}>
        ...
        {[...Array(6)].map((_, index) => (
                ...
                key={index}
                  ...
                  error={formik.touched[`code${index + 1}`] && Boolean(formik.errors[`code${index + 1}`])}
